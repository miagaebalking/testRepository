	...
	<div class="outer">
        ...
        <!-- menubar.jsp 를 위에서 include 했기 때문에 contextPath 변수를 가져다 쓸 수 있다. -->
            ...
            <table>
                ...
                <tr>
                    <td>* 비밀번호</td>
                    <td><input type="password" id="pw1" name="userPwd" maxlength="15" required></td>
                    <td></td>
                </tr>
                <tr>
                    <td>* 비밀번호 확인</td>
                    <td><input type="password" id="pw2" maxlength="15" required></td> <!-- 단순 비교 확인 용도라 key 값을 부여 안해도 됨 -->
                    <td></td>
                </tr>
                <tr>
                    <td>* 이름</td>
            ...
            <div align="center">
                <button type="submit" id="register" onclick="return chkpwd();" disabled>회원가입</button>
        		...
        		$.ajax({
        			...
        			success : function(result){
        				...
        				if(result == 'NNNNN'){
        					...
        					//기존에 disabled 되어있던 회원가입 버튼을 사용가능하게 바꾸고
        					//id값을 변경할 수 없도록 readonly처리를 해주기
